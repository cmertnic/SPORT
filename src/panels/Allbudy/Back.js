...
const back1 = ({ go }) => {
  return (
    <Panel id="back1" style={{ backgroundColor: "#7B7B7B" }}>
      <PanelHeader>
        <p style={{ display: "flex", justifyContent: "left" }}>Тренировки</p>
      </PanelHeader>

      <Group style={{ marginInline: 20, paddingTop: 20, background: "#7B7B7B"}}
        header={<Header mode="primary" style={{ fontSize: 24, display: "flex", justifyContent: "center" }}>Тренировки для мышц спины</Header>}
      >
        ...
        <div style={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center",textAlign:"center" }}>
          <div className="qwerty">
            <p>Подтягивания</p></div>

          <div className="qwerty">
            <p>Тяга гантели одной рукой в наклоне</p></div>

          <div className="qwerty">
            <p>Пожимания плечами (гантели)</p></div>

          <div className="qwerty">
            <p>Наклонные подтягивания</p></div>

          <div className="qwerty">
            <p>Обратные махи гантелями лёжа на животе</p></div>
